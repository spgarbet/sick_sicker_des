...
The face validity of the model is broken as a patient awaiting treatment 
...
account for resource contraints. We need to use the `clone` and `synchronize`
operators and do so without disturbing the original even loop.